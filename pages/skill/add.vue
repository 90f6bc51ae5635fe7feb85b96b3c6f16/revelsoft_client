...
const { generateSkillListID, } = useSkillList();
...
async function onSubmit() {
  ...
  try {
    ...
    skill_list_image.value.forEach(val => {
      if (val.files) {
        skill_list_imgs.push(val.files[0]);
      }
        ...
        <v-col cols="12" md="12">
          <v-row>
            <v-col cols="12" sm="6" lg="3">
              <v-label class="mb-2">รหัสทักษะ<span class="text-error ml-1">*</span></v-label>
              ...
              <div class="text-center" style="max-width: 400px;">
                <v-avatar size="200px">
                  ...
                  <template v-else-if="list.skill_list_img">
                    <v-img :src="`${publicCtx.apiBaseUrl}${list.skill_list_img}`" aspect-ratio="1" cover
                      max-height="200px">
