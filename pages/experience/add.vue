...
import { Experience } from "~~/misc/types"
...
let selectedRange = ref<Number>();
let minValue = ref<Number>();
let maxValue = ref<Number>();
...
<template>
  ...
  <v-card elevation="10" class="withbg">
    ...
    <!-- <div>
      ...
      <input type="range" id="range" v-model="selectedRange" />
      <p> {{ selectedRange }}</p>
    </div> -->
